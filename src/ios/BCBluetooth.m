...
- (void)variableInit{
    ifVariableInit = TRUE;
    endForAddService = FALSE;
    isAddAllData = FALSE;
    isConnectByManager = FALSE;
    ifRead = FALSE;
...
- (void)getEnv:(CDVInvokedUrlCommand *)command{
    ...
    [callbackInfo setValue:XXXXXX forKey:DEVICE_ID];
    [callbackInfo setValue:XXXXXX forKey:APP_ID];
