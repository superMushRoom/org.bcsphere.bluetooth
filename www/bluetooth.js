...
var bluetooth = {
    ...
    discoverDescriptors: function(successFunc,errorFunc,deviceID,serviceIndex,char_index){
	...
	removeService : function(successFunc,errorFunc,uniqueID){
		cordova.exec(successFunc,errorFunc, "BCBluetooth", "removeService",[{"uniqueID":uniqueID}]);
	},
	...
	getEnv : function(successFunc,errorFunc){
		cordova.exec(successFunc,errorFunc, "BCBluetooth", "getEnv",[]);
	},
